                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Recent photos grid - Modified to navigate to SinglePostViewScreen and conditionally display
                        if (_postsCount > 0) // Only show if there are posts
                          FutureBuilder<QuerySnapshot>(
                            future:
                                _firestore
                                    .collection('posts')
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (snapshot.hasData &&
                                ...
                                // No posts to show (already handled by the outer if, but kept for clarity)
                                return const SizedBox.shrink(); // Return an empty widget
                                /* No placeholders, photo grid is hidden if there are no photos
                                  photoWidgets = List.generate(
                                    6,
                                    (index) => Container(
                                      decoration: BoxDecoration(
